...
TopoDS_Shape
MakeCube(const Standard_Real myWidth,
           const Standard_Real myThickness)
{
  // Profile : Define Support Points
  gp_Pnt aPnt1(-myWidth / 2., -myWidth / 2, 0);        
  gp_Pnt aPnt2( myWidth / 2., -myWidth / 2, 0);        
  gp_Pnt aPnt3( myWidth / 2.,  myWidth / 2, 0);        
  gp_Pnt aPnt4(-myWidth / 2.,  myWidth / 2, 0);        
...
*/
  ...
  facesToRemove.Append(faceToRemove);
  BRepOffsetAPI_MakeThickSolid aSolidMaker;
  aSolidMaker.MakeThickSolidByJoin(myBody, facesToRemove, -myThickness, 1.e-3);
  myBody = aSolidMaker.Shape();
